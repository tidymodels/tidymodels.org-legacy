...
The data are overwhelmingly events: `r events_17` out of `r nrow(dat_17)` observations. Also, the censoring weights are larger now since the probability of being censored is very low. The mean censoring weight is `r round(mean(dat_17$.weight_censored), 2)`.
