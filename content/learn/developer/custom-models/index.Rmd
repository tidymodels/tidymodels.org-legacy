---
title: "Custom parsnip model functions"
tags: [parsnip]
categories: []
---
...
The main hyper-parameter is the number of subclasses. We'll name our function `discrim_mixture`. 
...
### What is `defaults` slot and why do I need it?
