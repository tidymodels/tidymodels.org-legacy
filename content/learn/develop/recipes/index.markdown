...
{{% note %}} If you are writing steps for an extension package, then every step should have a `required_pkgs()` method. It must return the package name, in addition to the required dependencies. {{%/ note %}}
