...
The `cbind()` call is pretty awkward and is a consequence of how the traditional formula infrastructure works. The recipes package is a lot easier to work with and this document shows an example to illustrate how to use multiple outcomes.   
