...
We'll start by fitting a random forest model to a small set of parameters. Let's say that the model would include the predictors `r knitr::combine_words(pred_names)`. A simple random forest model can be specified via:
