...
pkgs <- c("baguette", "broom", "butcher", "corrr", "dials", "discrim", 
          ...
          "poissonreg", "probably", "recipes", "rsample", "textrecipes", 
          "tidyposterior", "tidypredict", "yardstick", "workflows")
pkgs <- tibble(pkg = pkgs, 
               base_url = case_when(pkg == "butcher" ~ "https://tidymodels.github.io/butcher/",
