...
tags: [recipes, textrecipes, glmnet, textfeatures, textrecipes, text data, classification models, model tuning, grid search, Bayesian optimization]
---
...
In addition to the `tidymodels` package, this example uses the `glmnet`, `textfeatures`, `textrecipes`, and `modeldata` packages. 
