...
tags: [parsnip, keras, classification models]
---
...
In addition to the `tidymodels` package, this example uses the `modeldata` and `keras` packages (with tensorflow installed via `keras::install_keras()`). 
