...
tags: [embed, recipes, ggiraph, classification models, feature engineering, categorical predictors, Bayesian analysis, mixed models]
---
...
In addition to the `tidymodels` package, this example uses the `ggiraph`, `modeldata`, `rstanarm`, and `lme4` packages. 
