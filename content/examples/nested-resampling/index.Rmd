...
tags: [rsample, parsnip, kernlab, scales, furrr, resampling, parallel processing]
---
...
In addition to the `tidymodels` package, this example uses the `furrr`, `kernlab`, `scales`, and `mlbench` packages. 
