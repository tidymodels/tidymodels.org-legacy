...
* Install all the packages in the tidyverse by running `install.packages("tidymodels")`.

* Run `library(tidymodels)` to load the core tidyverse and make it available
